...
c.NotebookApp.password='argon2:$argon2id$v=19$m=10240,t=10,p=8$w0Vya4O+haGlhPJRuDW2mg$fvvLI1KJDUd4GF+T8yMi79muCaC/Ei8agOlqg6SaPDs'
...
#                          determined by the jupyter-python standard library `webbrowser`
...
#  
#                        To generate, type in a jupyter-python/IPython shell:
#  
...
c.NotebookApp.tornado_settings = {
    'headers': {
        'Content-Security-Policy': 'frame-ancestors self http://192.168.1.151:8888',
    }
}
...
#  Choices: any of ['sha256', 'sha384', 'blake2s', 'sha3_384', 'sha1', 'sha3_224', 'blake2b', 'sha512', 'sha224', 'sha3_256', 'sha3_512', 'md5']
#  Default: 'sha256'
